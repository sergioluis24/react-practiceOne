export function CardHome({ job }) {
  return (
    <>
      <div className="w-[350px] flex flex-col shrink-0 bg-neutral-primary-soft   p-10 border border-default border-slate-50/50 rounded-xl shadow-xs cursor-pointer">
        <div className="mb-4">
          <svg
        ...
        <a href="#">
          <h5 className="mb-4 text-2xl font-semibold tracking-tight text-heading">
            {job.titulo}
          </h5>
        </a>
        <div className="flex flex-col justify-between h-full ">
          <p
            className="mb-3 text-body text-red-50/80 text-pretty  max-h-56
  overflow-hidden
  ...
  [-webkit-mask-image:linear-gradient(to_bottom,black_70%,transparent_100%)]"
          ...
          <a
            href="#"
            className="inline-flex text-xl font-medium items-center text-fg-brand hover:underline text-[#1d7dde] hover:text-shadow-sm hover:text-shadow-[#1d7dde]/20"
          >
            Aplicar
          </a>
        </div>
